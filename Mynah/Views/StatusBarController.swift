...
final class StatusBarController: NSObject {
    ...
    private func configureButton() {
        ...
        button.image = NSImage(systemSymbolName: "mic", accessibilityDescription: "Mynah")
    ...
    private func buildMenu() -> NSMenu {
        ...
        guard settings.hasCompletedOnboarding else {
            ...
            let quitItem = NSMenuItem(
                title: String(localized: "Quitter Mynah"),
        ...
        let quitItem = NSMenuItem(title: String(localized: "Quitter Mynah"), action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
        quitItem.image = NSImage(systemSymbolName: "xmark.circle", accessibilityDescription: nil)
        menu.addItem(quitItem)
    ...
    func updateIcon(for state: PipelineState) {
        ...
        switch state {
        case .idle:
            button.image = NSImage(systemSymbolName: "mic", accessibilityDescription: "Mynah")?.withSymbolConfiguration(config)
