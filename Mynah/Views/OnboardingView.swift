...
struct OnboardingView: View {
    ...
    private var microphonePage: some View {
        pageLayout(
            ...
            subtitle: "Mynah a besoin du micro pour capturer votre voix. Sans cette autorisation, la dictée ne peut pas fonctionner."
        ) {
            VStack(spacing: 10) {
    ...
    private var accessibilityPage: some View {
        pageLayout(
            ...
            subtitle: "Mynah a besoin de l'autorisation d'Accessibilité pour écouter votre touche ou combinaison de touches et coller le texte directement dans vos applications."
        ) {
            VStack(spacing: 12) {
                if isAXTrusted {
                        ...
                        VStack(spacing: 8) {
                            ...
                            HStack(spacing: 12) {
                                Button {
                                    ...
                                    Label("Relancer Mynah", systemImage: "arrow.clockwise")
                                }
    ...
    private var donePage: some View {
        pageLayout(
            ...
            title: "Tout est prêt",
            subtitle: "Mynah vit dans la barre de menus. Retrouvez-y vos modèles, votre historique et vos réglages."
        ) {
            EmptyView()
        }
    }
    ...
    private func append(_ preset: PromptPreset) {
        ...
        services.settings.initialPrompt = current.isEmpty ? text : current + "\n" + text
    }
